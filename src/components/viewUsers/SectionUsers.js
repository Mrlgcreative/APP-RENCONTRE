          ...
          <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
            {User.map((User, index) => (
              ...
              <div key={index} className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={User.videoUrl} alt="Bonnie Avatar" />
                </a>
                <div className="p-5">
                  {/* ///////////// */}
                  <div className="flex items-center">
                    ...
                    <div className="block ml-2">
                      ...
                      <p className=" ml-3 text-gray-500 ">{User.description} </p>
                    </div>
                  </div>
                  {/* /////////// */}
                    ...
                    <li className="">
                      ...
                      <button onClick={() => setOpenLikeModal(true)} className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <div className=" flex justify-center   text-center ">
                          ...
                          <svg className={`w-[40px] h-[40px] animate-pulse text-gray-600 dark:text-gray-100 `} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="currentColor" viewBox="0 0 24 24">
            ...
            <Modal className="  customM " show={openLikeModal} size="md" onClose={() => setOpenLikeModal(false)} popup>
              ...
              <ModalHeader className="dark:bg-gray-800 p-4" />

              <ModalBody className="dark:bg-gray-800">
                <div className="text-center -mt-10">
                  <div className=" flex items-center justify-center ">

                    <img src={umoji[index]} alt={`Image ${index + 1}`} width={120} height={120} />

                  </div>
                  <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                    Are you sure you want to delete this product?
                  </h3>
                  <div className="items-center justify-center items-center text-center mb-5 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">

                    <div className="p-5 justify-center items-center te">
                      {/* ///////////// */}
                      ...
                      <br/>
                      <a href="" className="grid grid-cols-5 text-center grid-rows-5 gap-4 border bg-gray-200 dark:bg-gray-800 dark:hover:bg-green-600 hover:bg-green-400 h-7 p-3  border-green-600 rounded justify-center items-center text-center ">
                          <div className="col-span-4 ">
                        <h1 className="mt-3  mb-4 cursor-pointer text-gray-500 dark:text-gray-300">jljndljpour </h1>

                          </div>
                          <div className="col-start-5">
                        <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f48c/512.gif" alt="💌" width={20} height={20} />

                          </div>
                      </a>
                      <a href="" className="grid grid-cols-5 text-center grid-rows-5 gap-4 mt-1 border bg-gray-200 dark:bg-gray-800 dark:hover:bg-green-600 hover:bg-green-400 h-7 p-3  border-green-600 rounded justify-center items-center text-center ">
                          <div className="col-span-4 ">
                        <h1 className="mt-3  mb-4 cursor-pointer text-gray-500 dark:text-gray-300">jljndljpour </h1>

                          </div>
                          <div className="col-start-5">
                        <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fae1/512.gif" alt="🫡" width={20} height={20} />
                      ...
                      {/* <a href="" className="flex border  bg-gray-200 dark:bg-gray-800 dark:hover:bg-green-600 hover:bg-green-400 h-7 p-3  border-green-600 rounded-full justify-center items-center text-center gap-3">

                        <h1 className="mt-3  mb-4  cursor-pointer text-gray-500 dark:text-gray-300">cliquer ic skfjljdfflksdfjljpour </h1>
                       <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fae1/512.gif" alt="🫡" width={20} height={20} />
