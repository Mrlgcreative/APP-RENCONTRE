  ...
  return (
    <>
      ...
      <div className="relative">
        ...
        >
          ...
          <span className="absolute top-0 right-0 flex p-1 items-center justify-center 
            rounded-full bg-green-500 text-black text-xs font-bold animate-bounce">
            90
          </span>
      ...
      <Modal className="   " show={openNotifModal} size="md" onClose={() => setopenNotifModal(false)} popup>
        ...
        <ModalHeader className="dark:bg-gray-900  p-4"  />

        <ModalBody className="dark:bg-gray-900  h-3/4">
